...
ZSH_THEME_GIT_PROMPT_PREFIX="%{$reset_color%} on%{$terminfo[bold]$fg[yellow]%}"
ZSH_THEME_GIT_PROMPT_SUFFIX="%{$reset_color%} "
ZSH_THEME_GIT_PROMPT_DIRTY="%F{blue}*%f"
...
PROMPT='%{$terminfo[bold]$fg[white]%}%n%{$reset_color%}%{$terminfo[bold]$fg[white]%} at %{$reset_color%}%{$terminfo[bold]$fg[green]%}%m%{$reset_color%}%{$terminfo[bold]$fg[white]%} in %{$reset_color%}%{$terminfo[bold]$fg[red]%}%0~$ZSH_THEME_GIT_PROMPT_PREFIX$(git_branch)%{$terminfo[bold]$fg[white]%} ⇒%{$reset_color%}  '